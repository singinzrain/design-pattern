package com.dp.structural._10_Facade;
...
//    feulMonitor.turnOff();
  ...
  private class BoeingAltitudeMonitor {
  }

  private class BoeingEngineController {
  }

  private class BoeingFuelMonitor {
  }

  private class BoeingNavigationSystem {
  }
}
